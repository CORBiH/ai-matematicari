...
def exact_lesson_skill_failure(lesson_title, task_text):
    ...
    Ne zove ga aktivni server (objavu čuva `tutor/package_preflight.py`), nego
    ZVANIČNA KAPIJA IZDANJA (`scratchpad/run_difficulty_canary.py`) — njoj
    treba NEZAVISNA provjera da vidljivi zadatak stvarno traži vještinu koju
    naslov lekcije obećava. Zato ostaje i poslije povlačenja starog motora."""
