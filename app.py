...
COMMON_RULES = (
    ...
    "  'objasni mi to', 'možeš li bolje objasniti', 'pojasni', "
    "  'ne razumijem', 'možeš li još jednom' i slično, a ne pošalje novi zadatak, "
    "  PODRAZUMIJEVAJ da se to odnosi na TVOJ POSLJEDNJI ODGOVOR na isti zadatak. "
    "  U tom slučaju ne traži novi zadatak, nego ponovo objasni isti zadatak, "
    "  jasnije i jednostavnije (korak-po-korak, uz dodatne primjere ako pomažu). "
