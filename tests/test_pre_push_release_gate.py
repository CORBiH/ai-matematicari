...
def passing_document(commit_sha, tree_hash):
    ...
    return {
        ...
        # Proširena pokrivenost: Explain i Quick (tekst + slika) troše tačno
        # jedan poziv po turnu, pa je zbir fiksan (4 + 4). Stvarni zbir je
        # 17 + 0 + 4 + 4 + 4 = 29, a plafon 23 + 4 + 4 + 4 = 35.
        "covered_modes": ["practice", "kontrolni", "explain", "quick_text",
                          "quick_image"],
        "explain_sdk_calls": 4,
        "explain_required_turns": 4,
        "explain_turns": [
            {"role": "explain_same_lesson", "sdk_calls": 1, "status": "ready",
             "errors": []},
            {"role": "explain_off_lesson", "sdk_calls": 1, "status": "ready",
             "errors": []},
            {"role": "explain_percent_relevance", "sdk_calls": 1, "status": "ready",
             "errors": []},
            {"role": "explain_deictic_followup", "sdk_calls": 1, "status": "ready",
             "errors": []},
        ],
        "quick_sdk_calls": 4,
        "quick_required_turns": 4,
        "quick_turns": [
            {"role": "quick_bare_problem", "sdk_calls": 1, "status": "ready",
             "errors": []},
            {"role": "quick_explanation_stays_quick", "sdk_calls": 1,
             "status": "ready", "errors": []},
            {"role": "quick_legitimate_zero", "sdk_calls": 1, "status": "ready",
             "errors": []},
            {"role": "quick_new_image", "sdk_calls": 1, "status": "ready",
             "errors": []},
        ],
        "actual_sdk_calls": 29,
