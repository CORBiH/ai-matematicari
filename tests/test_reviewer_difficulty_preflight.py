...
@pytest.mark.parametrize("updates,expected_code", [
    ...
    pytest.param({"operation_count": 2},
                 "level_1_is_not_direct_introductory_application", id="two-operations"),
    ...
    pytest.param({"representation_change_count": 1},
                 "level_1_is_not_direct_introductory_application", id="representation-change"),
...
LEVEL_CASES = [
    ...
    pytest.param(1, {"operation_count": 2}, True, id="L1-two-operations-issue"),
